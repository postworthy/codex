...
impl App {
    ...
    pub(super) async fn handle_exit_mode(
        ...
        match mode {
            ExitMode::ShutdownFirst | ExitMode::Reload | ExitMode::ShutdownAfterInterrupt => {
                ...
                let reason = match mode {
                    ...
                    ExitMode::Reload => ExitReason::ReloadRequested,
                    ExitMode::ShutdownAfterInterrupt => ExitReason::TurnInterrupted,
                    ExitMode::Immediate => unreachable!("handled in separate match arm"),
                };
                AppRunControl::Exit(reason)
            }
            ExitMode::Immediate => {
